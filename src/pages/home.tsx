...
export function MainPage() {
  ...
  const isOrder = useAppSelector(state => state.modal.isOrder);

  const constructorIngredients = useAppSelector(state => state.constructor_burger.ingredients);
  const constructorBun = useAppSelector(state => state.constructor_burger.bun);
      ...
      <main className={styles.main__container}>
        ...
        {!isFailed && !isLoading && ingredients.length &&
          <>
            ...
            <div className={styles.container}>
              {isModalOpen && isOrder && orderDetails &&
